<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcedimientoDiagramadeFlujo.aspx.cs" Inherits="SIMANET_W22R.General.ProcedimientoDiagramadeFlujo" %>
...
<body>
    <form id="form1" runat="server">
     ...
     Diagrama.Data.ListarBtnOpciones = function () {
         ...
         var oParam = new SIMA.Param("IdtblModulo", "19", TipodeDato.Int);
     ...
     Diagrama.Drawing.Tools.Paint = function () {
         ...
         var GraphPatron = {};
         Diagrama.Data.ListarBtnOpciones().Select("CODIGO", "!=", "6").forEach(function (oDataRow, i) {
             var strPatron = "{" + oDataRow["BTNTOOL"].toString().Replace("|", cmll) + "}";
             eval("GraphPatron = " + strPatron + ";");
             if (oDataRow["CODIGO"].toString().Equal("3")) {
             ...
             else if (oDataRow["CODIGO"].toString().Equal("7")) {
