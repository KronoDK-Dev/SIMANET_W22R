<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListarIncidenciaPorArea.aspx.cs" Inherits="SIMANET_W22R.HelpDesk.Incidencia.ListarIncidenciaPorArea" %>
...
<body>
  ...
  <script>
      ...
      function LoadIni() {
          ...
          var OneNode = { id: BaseBE.ID_SERV_PROD, name: "Incidencia Disponibles", open: true, iconSkin: "pIcon01", Data: BaseBE, noR: true, children: null, font: { 'font-weight': 'bold', 'color': 'blue', 'font-style': 'italic' } };
          arrData.Add(OneNode);
          ListarIncidenciaPorArea.EasyControl.Tree(OneNode);
      }
      ListarIncidenciaPorArea.Data = {};
      ListarIncidenciaPorArea.EasyControl = {};


      ListarIncidenciaPorArea.Data.Servicios = function (IdServicioPadre) {
      ...
      ListarIncidenciaPorArea.EasyControl.Tree = function (oNodoPadre) {
          var NewCollection = new Array();
          ListarIncidenciaPorArea.Data.Servicios(oNodoPadre.id).Rows.forEach(function (oDataRow, f) {
              var DataBE = "".Serialized(oDataRow, true);
              var StrNombre = DataBE.NOMBRE.toString();
              var NodoBE = null;
              var ObjLogBE = ListarIncidenciaPorArea.Trace.Log.Find('Svr', DataBE.ID_SERV_PROD.toString());
              ...
              if ((DataBE.NROHIJOS.toString() != "0")) {
                  ListarIncidenciaPorArea.EasyControl.Tree(NodoBE);
              }
      ...
      ListarIncidenciaPorArea.EasyControl.Tree.ItemSelect = null;
      //Eventos de treeview 
      ListarIncidenciaPorArea.EasyControl.Tree.zTreeOnNodeCreated = function (event, treeId, treeNode) {
      ...
      ListarIncidenciaPorArea.EasyControl.Tree.onbeforeClick = function (treeId, treeNode, clickFlag) {

      }
      ListarIncidenciaPorArea.EasyControl.Tree.onClick = function (event, treeId, treeNode, clickFlag) {
          ListarIncidenciaPorArea.EasyControl.Tree.ItemSelect = treeNode;
          var DataBE = ListarIncidenciaPorArea.EasyControl.Tree.ItemSelect.Data;
          var ArrayPath = DataBE.PATHSERVICE.toString().split('|');
          EasyPathService.Clear();
          var oItemPath = new EasyPathService.PathItem("1", "", "", EasyPathService.TipoItem.Home);
          EasyPathService.Add(oItemPath);
          ArrayPath.reverse().forEach(function (ItemPathText, p) {
              oItemPath = new EasyPathService.PathItem(ItemPathText, ItemPathText, "", EasyPathService.TipoItem.Default);
              EasyPathService.Add(oItemPath);
          });
          EasyPathService.Paint();
      }

      ListarIncidenciaPorArea.EasyControl.Tree.DblClick = function (event, treeId, treeNode, clickFlag) {
          ...
          var oParam = new SIMA.Param(ListarIncidenciaPorArea.KEYIDSERVICIOAREA, oDataBE.ID_SERV_AREA);
          oColletionParams.Add(oParam);
          oParam = new SIMA.Param(ListarIncidenciaPorArea.KEYNOMBRESERVICIO, oDataBE.NOMBRE);
          oColletionParams.Add(oParam);
          oParam = new SIMA.Param(ListarIncidenciaPorArea.KEYIDAREA, ListarIncidenciaPorArea.Params[ListarIncidenciaPorArea.KEYIDAREA]);
          oColletionParams.Add(oParam);
          //Datos adicionales 
          oParam = new SIMA.Param(ListarIncidenciaPorArea.KEYIDCONTACTO, oDataBE.ID_CONTACT);
          oColletionParams.Add(oParam);
      ...
      ListarIncidenciaPorArea.EasyControl.Tree.Expand = function (event, treeId, treeNode) {
          var ObjLogBE = ListarIncidenciaPorArea.Trace.Log.Find('Srv', treeNode.id);
          ...
          ListarIncidenciaPorArea.Trace.Log.Save('Srv', ObjLogBE);
          if (treeNode.Load == false) {
              ListarIncidenciaPorArea.EasyControl.Tree(treeNode);
              treeNode.Load = true;
          }
      }
      ...
      var setting = {
          ...
          callback: {
              beforeClick: ListarIncidenciaPorArea.EasyControl.Tree.onbeforeClick,
              onClick: ListarIncidenciaPorArea.EasyControl.Tree.onClick,
              onDblClick: ListarIncidenciaPorArea.EasyControl.Tree.DblClick,
              onNodeCreated: ListarIncidenciaPorArea.EasyControl.Tree.zTreeOnNodeCreated,
              onExpand: ListarIncidenciaPorArea.EasyControl.Tree.Expand,
      ...
      var treeObject = null;
      var NombreTree = "treeNavSrv_" + ListarIncidenciaPorArea.Params[ListarIncidenciaPorArea.KEYIDAREA];
