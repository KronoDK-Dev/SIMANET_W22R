<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetalleComponentesServicio_StakeHolder.aspx.cs" Inherits="SIMANET_W22R.HelpDesk.Servicios.DetalleComponentesServicio_StakeHolder" %>
    ...
    <form id="form1" runat="server">
        <cc1:EasyGridView ID="EasyGridView1" runat="server" AutoGenerateColumns ="False">
            ...
            <DataInterconect MetodoConexion="WebServiceExterno">
                ...
                <Metodo>ListarRespxServicio</Metodo>
            ...
            <Columns>
                <asp:BoundField DataField="ID_REPONSABLE" HeaderText="ID" />
                <asp:BoundField DataField="APELLIDOSYNOMBRES" HeaderText="NOMBRE" />
