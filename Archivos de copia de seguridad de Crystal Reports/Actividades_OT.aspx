...
<body>
        ...
        <tr>
         ...
         <td> 
               ...
               <table class="w-100" border="0"  >
                 ...
                 <tr>
                     <td width="15%" >
                         <asp:Label ID="Label2" runat="server" Text="N° de Orden de Trabajo:" CssClass="tabulacion-control"
                             BorderWidth="0px" Width="100%"></asp:Label>
                     </td>
                     <td colspan="2">
                       <cc3:EasyNumericBox ID="enbOTs" runat="server" CssClass="input-control" NroDecimales="0" STYLE="width:90px" EnableOnChange="True" 
               ...
               <!--   ********************************  -->       
                  <tr>
                    <td  width="15%">
                        <asp:Label ID="Label1" runat="server" Text="Línea de Negocio:" CssClass="tabulacion-control" 
                            BorderWidth="0px" Width="100%"></asp:Label>
                    </td>
                    <td class="auto-style2" colspan="2" >
                          <cc3:EasyDropdownList ID="EDDL_LineaNegocio" runat="server" Width="34%" 
                           ...
                           EnableOnChange="True"  
                           autocomplete="on" CssClass="input-control" Requerido="True" AutoPostBack="True" MensajeValida="Este dato es obligatorio" Etiqueta="Línea Negocio">
                ...
                <!--   *******fila espacio*************************  -->                           
                 ...
                 <tr>
                     <td  width="15%" class="auto-style1">
                         <asp:Label ID="Label3" runat="server" Text="Actividad:" CssClass="tabulacion-control" 
                              BorderWidth="0px" Width="100%"></asp:Label>
                     </td>
                     <td  class="auto-style1" width="25%"  >
                          <cc3:EasyDropdownList ID="EDDL_Actividad" runat="server" Width="90%" MensajeValida="Este dato es obligatorio" Requerido="True" Etiqueta="Actividades" CssClass="input-control" AutoPostBack="True" OnSelectedIndexChanged="EDDL_Actividades_Select" OnTextChanged="EDDL_Actividades_Select" >
                          </cc3:EasyDropdownList>
                        
                     </td>
                     <td >
                         <asp:ImageButton ID="btnCarga" runat="server" ImageAlign="Middle" ToolTip ="Listas Actividades"   CssClass="image-button" 
                 ...
                 <tr>
                    ...
                    <td  class="auto-style1" colspan =2 >
                            <asp:Label ID="lblDescripción" runat="server" Text="" CssClass="input-control auto-resize-label " 
                              BorderWidth="0px" Width="80%"></asp:Label>
              ...
              <!--   *******fila espacio*************************  -->    
                 ...
                 <tr>
                     <td width="15%" class="auto-style3">
                         <asp:Label ID="Label4" runat="server" Text="Usuario Solicitante Cambio:" CssClass="tabulacion-control"
                              BorderWidth="0px" Width="100%"></asp:Label>
                     </td>
                    <td width="28%" >
              ...
              <!--   ********************************  -->   
                  <tr>
                     <td  width="15%">   
                         <asp:Label ID="Label6" runat="server" Text="DESCRIPCIÓN A ACTUALIZAR:" CssClass="tabulacion-control"
                              BorderWidth="0px" Width="100%" Visible ="true" ></asp:Label></td>
                        <td colspan=2>
                            <cc3:EasyTextBox ID="ETdescripcion" runat="server" Width="80%"
    ...
    <script>
        ...
        Actividades_OT.ObtenerAmbiente = function () {
            return SIMA.Utilitario.Helper.Configuracion.Leer("Seguridad", "Ambiente");
        }
