<%@ Page  Language="C#"  AutoEventWireup="true" CodeBehind="NObjetivos.aspx.cs" Inherits="SIMANET_W22R.GestionPersonal.EvaluacionDesempenio.NObjetivos" %>
...
<body>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="text-center mb-0">
                <p class="section-title mb-0">OBJETIVOS</p>
            </div>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <div class="text-center mb-2">
                <p class="section-title mb-0">OBJETIVOS DEL TRABAJADOR</p>
            </div>

            <div class="card shadow-sm mb-4">
                <div class="card-header bg-primary text-white">
                    <i class="bi bi-flag-fill me-2"></i>Asignación de Objetivos
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        <thead class="table-light">
                            <tr>
                                <th style="width: 106px;">DNI</th>
                                <th style="width: 50px;">ID</th>
                                <th style="width: 400px;">Objetivo</th>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <asp:TextBox ID="txtDNIOBJ" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td colspan="2" style="width:620px;">
                                    <asp:TextBox ID="txtObjetivo" runat="server" CssClass="form-control" placeholder="Escriba el objetivo" Width="100%"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:Button ID="btnAgregarObj" runat="server" Text="Agregar" CssClass="btn btn-success w-80" OnClick="btnAgregarObj_Click" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <!-- Tabla de objetivos -->
                    <asp:GridView ID="gvObjetivos" runat="server" CssClass="table table-bordered table-sm"
                        AutoGenerateColumns="False" ShowHeaderWhenEmpty="True" EmptyDataText="No hay objetivos agregados"
                        DataKeyNames="dni,id"
                        OnRowEditing="gvObjetivos_RowEditing"
                        OnRowUpdating="gvObjetivos_RowUpdating"
                        OnRowCancelingEdit="gvObjetivos_RowCancelingEdit"
                        OnRowDeleting="gvObjetivos_RowDeleting"
                        >
                        <Columns>
    ...
    <script>
        function confirmarEliminar(btn) {
            return confirm('¿Seguro que deseas eliminar este Objetivo?');
            }
    </script>
</body>
</html>