<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenerarPDF.aspx.cs" Inherits="SIMANET_W22R.GestionPersonal.EvaluacionDesempenio.GenerarPDF" %>
    ...
    <form id="form1" runat="server" class="container mt-4">
        <div class="card shadow-lg">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">Reporte PDF - Crystal Reports</h5>
            </div>
            <div class="card-body">
