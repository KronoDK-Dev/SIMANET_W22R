<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HeaderTest.ascx.cs" Inherits="SIMANET_W22R.Controles.HeaderTest" %>
      ...
      <!--******************************************STYLES****************************************************-->
        ...
        <!------------------------------------------UI------------------------------------------------------------------->
            ...
            <script src="http://code.jquery.com/ui/1.13.0/jquery-ui.min.js"></script> 
        <!---------------------------------------------------------------------------------------------------------------------->
