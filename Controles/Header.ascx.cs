        ...
        public string[,] StyleBase
        {
            get
            {
                return new string[15, 2]{ 
                    ...
                    ,{ "sweetalert2.min.css",EasyUtilitario.Helper.Pagina.PathSite()+"/Recursos/css/sweetalert2.min.css"}
                    ,{ "jtoastr.min.css",EasyUtilitario.Helper.Pagina.PathSite()+"/Recursos/css/toastr.min.css"}
        ...
        public string[,] ScriptBase
        {
            get
            {
                return new string[24, 2]{
                    ...
                    //,{ "FixSIMA", EasyUtilitario.Helper.Pagina.PathSite()+"/Recursos/LibSIMA/FixSIMA.js"}
                    ,{ "Objects", EasyUtilitario.Helper.Pagina.PathSite()+"/Recursos/LibSIMA/Object.js"}
