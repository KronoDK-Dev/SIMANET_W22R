...
<!--  Esta referencia esta ya en e Header.ascx como: sweetalert2.min.css"
<link href="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.css" rel="stylesheet">
-->
<!--  Esta referencia esta ya en e Header.ascx como: sweetalert2.all.min.js
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .ztree li span.button.pIcon01_ico_open {
            margin-right: 2px;
            background: url(../Recursos/img/zTreeStyle/img/diy/1_close.png) no-repeat scroll 0 0 transparent;
            vertical-align: top;
        ...
        .ztree li span.button.pIcon01_ico_close {
            margin-right: 2px;
            background: url(../Recursos/img/zTreeStyle/img/diy/1_open.png) no-repeat scroll 0 0 transparent;
            vertical-align: top;
            *vertical-align: middle
        }
        ...
        .ztree li span.button.pIcon02_ico_open, .ztree li span.button.pIcon02_ico_close {
            margin-right: 2px;
            background: url(../../../css/zTreeStyle/img/diy/2.png) no-repeat scroll 0 0 transparent;
            vertical-align: top;
            *vertical-align: middle
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- 21.01.2026 se cambia el nombre de este contro EasyPopupTestReportParam por que se duplica con un metodo java que se esta usando   -->
...
*/
    ...
    ReportExploreV2.btnExportaXLS = function () {
        ...
        buttonsContainer.style.top = (rect.top + scrollTop + 10) + "px"; // 10px desde arriba del iframe
        buttonsContainer.style.left = (rect.left + scrollLeft + rect.width / 2) + "px"; // centro horizontal
        buttonsContainer.style.transform = "translateX(-50%)";
        buttonsContainer.style.display = "flex"; // asegura que se muestre
    };
...
<script>
    ...
    // posiciona los botones de exportacion de excel -- SE COMENTA POR QUE AHORA SE USA LA funcion ReportExploreV2.btnExportaXLS
    /*
